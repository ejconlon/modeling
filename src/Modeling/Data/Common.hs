...
newtype NamespacePart = NamespacePart { unNamespacePart :: Text }
    ...
    deriving (HasGenRep JsonRep) via (GenRepNewtype NamespacePart Text)
...
newtype Namespace = Namespace { unNamespace :: Seq NamespacePart }
    ...
    deriving (HasGenRep JsonRep) via (GenRepNewtype Namespace (Seq NamespacePart))
...
newtype ParamName = ParamName { unParamName :: Text }
    ...
    deriving (HasGenRep JsonRep) via (GenRepNewtype ParamName Text)
...
newtype TypeName = TypeName { unTypeName :: Text }
    ...
    deriving (HasGenRep JsonRep) via (GenRepNewtype TypeName Text)
...
newtype EnumName = EnumName { unEnumName :: Text }
    ...
    deriving (HasGenRep JsonRep) via (GenRepNewtype EnumName Text)
...
newtype FieldName = FieldName { unFieldName :: Text }
    ...
    deriving (HasGenRep JsonRep) via (GenRepNewtype FieldName Text)
...
newtype BranchName = BranchName { unBranchName :: Text }
    ...
    deriving (HasGenRep JsonRep) via (GenRepNewtype BranchName Text)
